from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup, InlineKeyboardBuilder, ReplyKeyboardBuilder
...
hours_choose_kb = InlineKeyboardButton()
...
def get_minutes_choose_kb(hour: int):
